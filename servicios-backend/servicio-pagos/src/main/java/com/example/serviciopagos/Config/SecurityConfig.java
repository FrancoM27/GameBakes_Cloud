    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // El webhook de Mercado Pago llega sin token de usuario: se mantiene público.
                // Si quieres blindarlo más, valida la firma propia que envía Mercado Pago
                // en el handler del endpoint (no es un JWT de Entra ID).
